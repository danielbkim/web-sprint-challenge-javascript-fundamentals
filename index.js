...
// Nested function can access the variable internal is because of scope.  Children of the parent scope can always access data preceding it, however, parent scope (functions on the outside of the internal scope) cannot access the scope of its children.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(animalArray){
    return animalArray.filter(function(animal) {
  ...
  */
  ...
  function USApop(animalArray){
    // current value is animal
    // accumulator is undefined until you give it one?
    return animalArray.reduce(function(accumulator, currentValue){
      // console.log('This is accumulator: ', accumulator, 'This is currentValue: ', currentValue);
...
function CuboidMaker(dimensions){
  // console.log('These are the arguments: ', dimensions);
